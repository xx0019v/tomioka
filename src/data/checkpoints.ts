...
export const checkpoints: Checkpoint[] = [
  {
    ...
    visualSrc: withBasePath("/checkpoints/photos/otomi-chan-ie.webp"),
    visualAlt: "お富ちゃん家の外観。入口前でお富ちゃんが来訪者を迎えている。",
    visualCredit: "写真：しるくるとみおか掲載素材（利用許諾確認済み）",
    visualSourceUrl: "https://www.tomioka-silk.jp/_shop/souvenir/detail/Otomi-chan-chi.html",
    notice: "上州富岡駅から徒歩約10分。周辺の有料駐車場をご利用ください。",
    sourceLabel: "富岡市観光公式サイト・富岡市公開情報（2026年7月確認）",
  },
  {
    id: "cp1",
    slug: "atelier",
    ...
    visualSrc: withBasePath("/checkpoints/photos/atelier.webp"),
    visualAlt: "アトリエの外観。かき氷とクレープの案内が入口に並んでいる。",
    visualCredit: "写真：しるくるとみおか掲載素材（利用許諾確認済み）",
  ...
  },
  {
    ...
    sourceStatus: "needs_review",
    visualSrc: withBasePath("/checkpoints/photos/okashige.webp"),
    visualAlt: "岡重肉店の外観。店頭のショーケースと手書きの商品札が見える。",
    visualCredit: "写真：しるくるとみおか掲載素材（利用許諾確認済み）",
  ...
  },
  {
    ...
    sourceStatus: "needs_review",
    visualSrc: withBasePath("/checkpoints/photos/ginza-koryukan.webp"),
    visualAlt: "銀座まちなか交流館の外観。白壁と瓦屋根の二階建ての建物。",
    visualCredit: "写真：しるくるとみおか掲載素材（利用許諾確認済み）",
  ...
  },
  {
    ...
    sourceStatus: "needs_review",
    visualSrc: withBasePath("/checkpoints/photos/kirinya-gate-context.webp"),
    visualAlt: "キリンヤ周辺の調査地点となる富岡製糸場表門。赤い丸形郵便ポストと煉瓦塀が見える。",
    visualCredit: "画像提供：富岡市・富岡製糸場（表門／地点写真）",
  ...
  },
  {
    ...
    sourceStatus: "needs_review",
    visualSrc: withBasePath("/checkpoints/photos/cafe-drome.webp"),
    visualAlt: "カフェドロームの外観。木枠の入口から店内の椅子と照明が見える。",
    visualCredit: "写真：しるくるとみおか掲載素材（利用許諾確認済み）",
