...
export const eventSpots: EventSpot[] = [
  ...
  },
  {
    ...
    sourceStatus: "day_of_event",
    visualSrc: withBasePath("/spots/photos/kirinya.webp"),
    visualAlt: "店先にお土産と洋品が並ぶキリンヤ洋品店の外観",
    visualCredit: "写真：旅するN-LIFE掲載素材",
    visualSourceUrl: "https://tabisuru-n-life.com/tomioka-silk-mill/",
    notice: "歩道に立ち止まる際は、周囲の通行を妨げないようご注意ください。",
    sourceLabel: "施設情報：公開マップ・掲載元を目視確認",
  },
  {
    id: "drome",
    slug: "cafe-drome",
